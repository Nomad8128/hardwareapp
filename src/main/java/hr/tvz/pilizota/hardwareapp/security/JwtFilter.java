package hr.tvz.pilizota.hardwareapp.security;

import hr.tvz.pilizota.hardwareapp.security.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean isEndpointAllowingUnauthenticatedAccess(HttpServletRequest request) {
        ...
        return hr.tvz.pilizota.hardwareapp.security.SecurityConfiguration.UNAUTHENTICATED_ENDPOINTS
                .stream()
